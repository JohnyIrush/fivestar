<template>
    <div class="mw-100 glass-content ">
       <div class="tab-content" id="pills-interview">
        <!--START START-->
        <div class="tab-pane fade show active" id="pills-leave-start" role="tabpanel" aria-labelledby="pills-leave-start-tab">
           <div class="row">
               <div class="col-12">
        ...
        <!--FORM WIZARD START-->
        <div class="tab-pane fade" id="pills-leave-form" role="tabpanel" aria-labelledby="pills-leave-form-tab">
           <div class="row">
        ...
        <div class="tab-pane fade" id="pills-leave-progress" role="tabpanel" aria-labelledby="pills-leave-progress-tab">
           <div class="row justify-content-center">
               <div class="col-2"></div>
    ...
    methods:
        {
            ...
            */
            startStepNext()
            {
              const currentTab = document.querySelector("#pills-leave-start")
              const nextTab = document.querySelector("#pills-leave-form")
            ...
            formStepNext()
            {
              const currentTab = document.querySelector("#pills-leave-form")
              currentTab.classList.remove("show", "active");

              const nextTab = document.querySelector("#pills-leave-progress")
              nextTab.classList.add("show", "active")
            }
            ,
            /**
            ...
            */
            ...
            {
              const currentTab = document.querySelector("#pills-leave-form")
              const nextTab = document.querySelector("#pills-leave-start")
              currentTab.classList.remove("show", "active");
              nextTab.classList.add("show", "active")
            },
            ...
            progressStepPrev()
            {
              const currentTab = document.querySelector("#pills-leave-progress")
              const nextTab = document.querySelector("#pills-leave-form")
              currentTab.classList.remove("show", "active");
              nextTab.classList.add("show", "active")
            }
