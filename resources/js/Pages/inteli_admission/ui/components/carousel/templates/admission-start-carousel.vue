...
<div class="container">
  <div class="carousel">
    <div class="carousel__face position-absolute"><span>This is something</span></div>
    <div class="carousel__face position-absolute"><span>Very special</span></div>
    <div class="carousel__face position-absolute"><span>Special is the key</span></div>
    <div class="carousel__face position-absolute"><span>For you</span></div>
    <div class="carousel__face position-absolute"><span>Just give it</span></div>
    <div class="carousel__face position-absolute"><span>A try</span></div>
    <div class="carousel__face position-absolute"><span>And see</span></div>
    <div class="carousel__face position-absolute"><span>How IT Works</span></div>
    <div class="carousel__face position-absolute"><span>Woow</span></div>
  </div>
</div>
</template>
