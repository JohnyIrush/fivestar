         ...
         <div class="row mt-2">
            <div class="col">
             <div class="form-group inputBox">
               ...
               <input type="date" id="birthday" v-model="details.birthday" @change="updateStudentStore()">
               <span class="line"></span>
             </div>
            </div>
            <div class="col">
...
export default defineComponent({
    ...
    methods:
    {
        ...
        updateStudentStore()
        {
          store.state.student.firstname = this.details.firstname
          store.state.student.lastname = this.details.lastname
          store.state.student.address = this.details.address
          store.state.student.city_id = this.details.city_id
          store.state.student.town_id = this.details.town_id
          store.state.student.gender_id = this.details.gender_id
          store.state.student.birthday = this.details.birthday
