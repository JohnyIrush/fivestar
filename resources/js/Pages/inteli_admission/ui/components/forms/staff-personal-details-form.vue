...
export default defineComponent({
    ...
    methods:
    {
        ...
        updateStudentStore()
        {
          store.state.staff.firstname = this.details.firstname
          store.state.staff.lastname = this.details.lastname
          store.state.staff.address = this.details.address
          store.state.staff.city_id = this.details.city_id
          store.state.staff.town_id = this.details.town_id
          store.state.staff.gender_id = this.details.gender_id
