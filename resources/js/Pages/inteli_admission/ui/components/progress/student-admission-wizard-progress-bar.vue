<template>
   <section class="step-wizard ">
	   <ul class="step-wizard-list glass-content">
		   ...
		   <li class="step-wizard-item current-item ">
			   ...
			   <span  class="progress-label">QUALIFICATIONS</span>
		   </li>
		   <li class="step-wizard-item">
			<span class="progress-count">4</span>
			<span  class="progress-label">ACADEMIC DETAILS</span>
		    </li>
			<li class="step-wizard-item">
				<span class="progress-count">5</span>
				<span  class="progress-label">CARRUCULAR ACTIVITIES</span>
			</li>
			<li class="step-wizard-item">
			...
			<li class="step-wizard-item">
				...
				<span  class="progress-label">FINANCIAL ACCOUNT</span>
			</li>
			<li class="step-wizard-item">
				<span class="progress-count">8</span>
				<span  class="progress-label">PORTAL</span>
			</li>
			<li class="step-wizard-item">
