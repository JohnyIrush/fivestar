      ...
      <!--<ul class="navbar-nav">
        <li class="nav-item">
          <Link class="nav-link" :href="route('installer')">
            ...
            <span class="nav-link-text ms-1">Installation</span>
          </Link>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <Link class="nav-link  " :href="route('academic')">
            <div class="icon text-white bg-gradient-info shadow border-radius-md text-center d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <Link class="nav-link  " :href="route('staff')">
            <div class="icon text-white bg-gradient-info shadow border-radius-md text-center d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <Link class="nav-link  " :href="route('library')">
            <div class="icon text-white bg-gradient-info shadow border-radius-md text-center d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <Link class="nav-link  " :href="route('finance')">
            <div class="icon text-white bg-gradient-info shadow border-radius-md text-center d-flex align-items-center justify-content-center">
              <i class="fas fa-microscope"></i>
            </div>
            <span class="nav-link-text ms-1">Research Center</span>
          </Link>
        </li>
        <li class="nav-item">
          <Link class="nav-link  " :href="route('finance')">
        ...
        <li class="nav-item">
          <Link class="nav-link  " :href="route('inventory')">
             <div class="icon text-white bg-gradient-info shadow border-radius-md text-center d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <Link class="nav-link  " :href="route('form')">
            <div class="icon text-white bg-gradient-info shadow border-radius-md text-center d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
               ...
               <Link class="nav-link  dropdown-item" :href="route('portal-guardian')">
                 <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                   <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                     <title>customer-support</title>
                     <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                 ...
                 <span class="nav-link-text ms-1">Guardian</span>
               </Link>
               <Link class="nav-link  dropdown-item" :href="route('portal-school')">
                 <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                   <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                     <title>customer-support</title>
                     <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
