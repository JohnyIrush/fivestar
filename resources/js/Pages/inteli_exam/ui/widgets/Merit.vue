<template>
           <div class="row">
             ...
             <div class="col-xl-4">
               <modal-button @showmodal="launchModal('main-modal')" :name="'Merits'" :icon_classes="'far fa-eye'" :title="'Merits'" :modalSize="'modal-xl'" :componentType="'table'" :componentName="'DataTable'" :dataPath="'exam/merit/index'"></modal-button>
             </div>
