<template>
           <div class="row">
             ...
             <div class="col-xl-4">
               <modal-button @showmodal="launchModal('main-modal')" :name="'Exams'" :icon_classes="'far fa-eye'" :title="'Exams'" :modalSize="'modal-xl'" :componentType="'table'" :componentName="'DataTable'" :dataPath="'exam/index'"></modal-button>
             </div>
