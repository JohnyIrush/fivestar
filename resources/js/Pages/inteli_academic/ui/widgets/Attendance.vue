<template>
            <div class="row">
              ...
              <div class="col-xl-4">
                <modal-button @showmodal="launchModal('main-modal')" :name="'Student Attendance'" :icon_classes="'far fa-eye'" :title="'Attendance'" :modalSize="'modal-xl'" :componentType="'table'" :componentName="'DataTable'" :dataPath="'academic/attendance/index'"></modal-button>
              </div>
