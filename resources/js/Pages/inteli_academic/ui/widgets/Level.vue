<template>
           <div class="row">
             ...
             <div class="col-xl-4">
               <modal-button @showmodal="launchModal('main-modal')" :name="'Levels'" :icon_classes="'far fa-eye'" :title="'Levels'" :modalSize="'modal-xl'" :componentType="'table'" :componentName="'DataTable'" :dataPath="'academic/level/index'"></modal-button>
             </div>
