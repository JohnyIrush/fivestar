<template>
               <div class="row">
                ...
                <div class="col-xl-4">
                  <modal-button @showmodal="launchModal('main-modal')" :name="'Clubs'" :icon_classes="'far fa-eye'" :title="'Clubs'" :modalSize="'modal-xl'" :componentType="'table'" :componentName="'DataTable'" :dataPath="'academic/club/index'"></modal-button>
                </div>
