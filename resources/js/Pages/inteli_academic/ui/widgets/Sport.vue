<template>
               <div class="row">
                 ...
                 <div class="col-xl-4">
                   <modal-button @showmodal="launchModal('main-modal')" :name="'Sports'" :icon_classes="'far fa-eye'" :title="'Sports'" :modalSize="'modal-xl'" :componentType="'table'" :componentName="'DataTable'" :dataPath="'academic/sport/index'"></modal-button>
                 </div>
