<template>
           <div class="row">
             ...
             <div class="col-xl-4">
               <modal-button @showmodal="launchModal('main-modal')" :name="'Streams'" :icon_classes="'far fa-eye'" :title="'Streams'" :modalSize="'modal-xl'" :componentType="'table'" :componentName="'DataTable'" :dataPath="'academic/stream/index'"></modal-button>
             </div>
