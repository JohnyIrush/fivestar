<template>
 <div class="container">
   ...
   <div class="">
           ...
           <div class="col ms-auto">
            <div class="row">
             <div class="col d-flex flex-row">
              ...
              <div class="">
               <div class="">
                <img src="/images/components/wolves-1400819_640.jpg" class="rounded float-left">
               </div>
              </div>
             </div>
             <div class="col">
            ...
            <div class="row">
                ...
                <div class="col">
                 <div class="d-flex flex-row">
                     ...
                     <button class="mr-4"><i class="fas fa-caret-down" data-bs-toggle="collapse" data-bs-target="#card-more" aria-expanded="false" aria-controls="card-more"></i></button>
                 </div>
                </div>
            </div>
           </div>
    ...
    <div class="row">
      <div class="col">
        <div class="collapse multi-collapse" id="card-more">
