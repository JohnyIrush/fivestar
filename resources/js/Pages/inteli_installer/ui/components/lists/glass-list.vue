<template>
    <div class="box">
        ...
        <div  class="list" v-for="item in list" :key="item.id">
            <div class="imgBx">
                <img class="img-size" :src="item.image" alt="" srcset="">
            </div>
            <div class="content">
                <h2 class="rank"><small>#{{item.id}}</small></h2>
                <h4>{{item.feature}}</h4>
                <p data-bs-toggle="tooltip" data-bs-placement="right" :title="item.description">Description</p>
            </div>
        </div>
    </div>
</template>
