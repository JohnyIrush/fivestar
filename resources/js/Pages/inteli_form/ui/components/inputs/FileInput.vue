   ...
   <!--START INPUT SETTINGS|OPTIONS|PROPERTIES -->
     <div class="row mt-3 mb-3" v-if="showfieldSettings">
      ...
      <div class="col-5 mt-2 mb-2">
       <div class="input-group ">
        ...
        <input 
          ...
          class="form-control form-input-transparent" 
          aria-label="" 
          aria-describedby="maxNoOfFiles-basic-addon">
        </div>
       </div>
      <div class="col-5 mt-2 mb-2">
       <div class="input-group ">
        ...
        <input 
          ...
          class="form-control form-input-transparent" 
          aria-label="" 
          aria-describedby="maxFileSize-basic-addon">
        <span 
          class="input-group-text" 
          id="maxFileSize-basic-addon">
          GB
      ...
      <div class="form-check form-switch">
        <label 
        class="form-check-label" 
        for="text-input-multiple-setting-check"
        >
        multiple
        </label>
        <input 
