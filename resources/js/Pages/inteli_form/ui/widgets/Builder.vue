      ...
      <div class="tab-pane fade show active" id="questions" role="tabpanel" aria-labelledby="questions-tab">
       <div class="card text-center glass-content">
        ...
        <draggable 
          ...
          :list="(isEmpty(formData)? formData.sections : form.sections)" 
          @change="log"
        >
        <div 
          class="row"
          v-for="(section, sectionindex) in (isEmpty(formData)? formData.sections : form.sections)" 
          :key="sectionindex" 
          >   
           ...
           <div class="col-12">
            ...
            <div class="card-body">
              <draggable 
               class="dragArea list-group w-full" 
               :list="(isEmpty(formData)? formData.sections[sectionindex].fields : form.sections[sectionindex].fields)" 
               @change="log">
          <div class="row">
           <div
             class="col-6"
             v-for="(field, index) in (isEmpty(formData)? formData.sections[sectionindex].fields : form.sections[sectionindex].fields)" 
             :key="index" 
