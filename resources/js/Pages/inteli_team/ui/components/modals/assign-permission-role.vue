...
<div class="container">
  ...
  <div class="modal fade" id="assign-permission-role-Modal"  data-bs-keyboard="false" tabindex="-1" aria-labelledby="assign-permission-role-Modal" aria-hidden="true">
        ...
        <div class="modal-body">
         <div class="mb-3">
          <div class="form-check" v-for="rolepermission in form.rolespermissions" :key="rolepermission">
            ...
            <!--<input class="form-check-input" type="checkbox" :value="rolepermission.id" v-show="form.type == 'Revoke-Permission' || form.type == 'Remove-Role'" checked>-->
    ...
    export default defineComponent({
        ...
        methods: {
            getSelectedOptions()
            {
                ...
                const index = this.selectedFields.indexOf('on');
                if (index > -1) {
                  this.selectedFields.splice(index, 1); // 2nd parameter means remove one item only
                }
            },
            performAction()
            {
