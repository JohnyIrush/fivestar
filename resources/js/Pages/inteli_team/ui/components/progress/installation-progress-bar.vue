<template>
   <section class="step-wizard ">
	   <div class="row step-wizard-list glass-content">
		   <div class="col step-wizard-item">
			   <span class="progress-count">1</span>
			   <span class="progress-label">Preparing</span>
		   </div>
		   <div class="col step-wizard-item current-item ">
			   <span class="progress-count">2</span>
			   <span class="progress-label">App</span>
		   </div>
		   <div class="col step-wizard-item">
			<span class="progress-count">3</span>
			<span class="progress-label">Packages</span>
		    </div>
			<div class="col step-wizard-item">
