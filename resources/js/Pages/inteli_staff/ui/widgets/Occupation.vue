<template>
           <div class="row">
             ...
             <div class="col-xl-4">
               <modal-button @showmodal="launchModal('main-modal')" :name="'Departments'" :icon_classes="'far fa-eye'" :title="'Department'" :modalSize="'modal-xl'" :componentType="'table'" :componentName="'DataTable'" :dataPath="'staff/department/index'"></modal-button>
             </div>
