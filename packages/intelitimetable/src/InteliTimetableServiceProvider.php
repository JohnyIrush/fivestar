...
namespace Softwarescares\Intelitimetable;

use Illuminate\Support\ServiceProvider;

class InteliTimetableServiceProvider extends ServiceProvider
{
    /**
     * Register services.
     *
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__.'/resources/views', 'intelitimetable'); //-- Package views
        ...
        $this->publishes([
            __DIR__.'/resources/js/Pages/Timetable' => public_path('../resources/js/Pages/Timetable'),
        ], 'intelitimetable-ui');
