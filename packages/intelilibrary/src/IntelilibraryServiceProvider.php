...
namespace Softwarescares\Intelilibrary;

use Illuminate\Support\ServiceProvider;

class IntelilibraryServiceProvider extends ServiceProvider
{
    /**
     * Register services.
     *
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__.'/resources/views', 'intelilibrary'); //-- Package views
        ...
        $this->publishes([
            __DIR__.'/resources/js/Pages/inteli_library' => public_path('../resources/js/Pages/inteli_library'),
        ], 'intelilibrary-ui');


        $this->publishes([
            __DIR__.'/database/seeders' => public_path('../database/seeders'),
        ],'intelilibrary-seeders');
