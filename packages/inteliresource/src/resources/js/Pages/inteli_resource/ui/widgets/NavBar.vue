...
<template>
    <div>
        ...
        <div class="">
            <nav class="sec-bg-color border-b border-gray-100">
    ...
    <!--
    <nav class="navbar glass-header navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl sec-bg-color nav-bar-height" id="navbarBlur" navbar-scroll="true">
