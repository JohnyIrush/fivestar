<template>
	<section class="mt-3">
		<div class="container">
			<div class="shadow rounded-lg  sec-bg-color d-block d-sm-flex">
				<div class="profile-tab-nav border-right">
					<div class="nav flex-column nav-pills sec-bg-color" id="v-pills-tab" role="tablist" aria-orientation="vertical">
