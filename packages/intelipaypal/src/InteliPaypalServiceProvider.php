...
namespace Softwarescares\Intelipaypal;

use Illuminate\Support\ServiceProvider;

class InteliPaypalServiceProvider extends ServiceProvider
{
    /**
     * Register services.
     *
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__.'/resources/views', 'intelipaypal'); //-- Package views
        ...
        $this->publishes([
            __DIR__.'/resources/js/Pages/inteli_paypal' => public_path('../resources/js/Pages/inteli_paypal'),
        ], 'intelipaypal-ui');


        $this->publishes([
            __DIR__.'/database/seeders' => public_path('../database/seeders'),
        ],'intelipaypal-seeders');
